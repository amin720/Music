...
var App = function() {
            ...
            if (themeColorCke) {
                if (themeColorCke === 'default') {
                    ...
                    if (themeLink.length) {
                        ...
                        $('link[href="~/assets/css/themes.css"]')
    ...
    var dtIntegration = function() {
        $.extend(true, $.fn.dataTable.defaults, {
            "sDom": "<'row'<'col-sm-6 col-xs-5'f><'col-sm-6 col-xs-7'l>r>t<'row'<'col-sm-7 col-xs-12 clearfix'p><'col-sm-5 hidden-xs'i>>",
            "sPaginationType": "bootstrap",
            "oLanguage": {
                "sLengthMenu": "_MENU_",
                "sSearch": "<div class=\"input-group\">_INPUT_<span class=\"input-group-addon\"><i class=\"fa fa-search\"></i></span></div>",
                "sInfo": "<strong>_TOTAL_</strong> از <strong>_START_</strong>-<strong>_END_</strong>",
                "oPaginate": {
                    "sPrevious": "",
                    "sNext": ""
                }
